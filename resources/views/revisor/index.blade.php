        ...
        @if ($article_to_check)
            <div class="row justify-content-center pt-3 px-xl-5">
                                        ...
                                        <div class="carousel-item {{ $key === 0 ? 'active' : '' }}">
                                            <div class="position-relative text-center bg-black"
                                                ...
                                                <img src="{{ Storage::url($image->path) }}"
                                                    ...
                                                    style="max-height: 450px; width: auto; display: inline-block; vertical-align: middle;"
                                                    alt="Immagine {{ $key + 1 }}">
                ...
                <div class="col-12 col-lg-5 ps-lg-4 d-flex flex-column justify-content-between">
                    <div
                        class="card bg-dark border border-secondary shadow-lg rounded p-4 h-100 d-flex flex-column justify-content-between">
                        <div>
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <span
                                    class="badge bg-black text-neon-cyan border border-secondary text-uppercase font-monospace tracking-wide px-3 py-2">
                            ...
                            <div class="p-3 bg-black rounded border border-secondary min-height-custom">
                                <label
                                    class="text-neon-cyan font-monospace small mb-2 d-block text-uppercase">Descrizione
                                    Prodotto</label>
                        ...
                        <div class="mt-4">
                            @if (session()->has('message'))
                                <div
                                    class="alert alert-success text-center shadow rounded border-0 bg-success bg-opacity-25 text-white d-flex align-items-center justify-content-center p-3 mb-3">
                            ...
                            <div class="d-flex justify-content-between gap-3">
                                <form action="{{ route('reject', ['article' => $article_to_check]) }}" method="POST"
                                    ...
                                    @method('PATCH')
                                    <button type="submit"
                                        class="btn btn-outline-danger py-2.5 w-100 fw-bold shadow-sm border-2">
                                ...
                                <form action="{{ route('accept', ['article' => $article_to_check]) }}" method="POST"
                                    ...
                                    @method('PATCH')
                                    <button type="submit"
                                        class="btn btn-success py-2.5 w-100 fw-bold shadow-sm text-black fw-black"
                                        style="background-color: #00ffcc; border: none;">
